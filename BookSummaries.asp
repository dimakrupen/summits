...
<input type="hidden" name="currentfileid">
    ...
    <img src='images/blue-arrow.gif' border='0'>&nbsp;<a href="javascript:document.frmMenu.action='BookSummariesSearch.asp';document.frmMenu.submit();">Search Entire Library</a>
    <br />
<img src="images/cap_booksummaries.gif"><%If sesClass2 = "Admin" Then %><input type="button" name="btnSubmit1" value="Add Category" onclick="fnAdd();" class="tblBase">
...
<%
strSQL = "SELECT * FROM Categories WHERE CategoryTypeID = 5"
...
If sesClass2 = "Admin" Then
	strSQL = "SELECT SharedStuff.*, userdata.first + ' ' + userdata.last as userdeleted, Categories.Category " & _
		...
		" WHERE SharedStuff.deleted = True AND CategoryTypeID = 5 " '& _
		'" AND (mygrouponly = False OR postedby IN " &_
